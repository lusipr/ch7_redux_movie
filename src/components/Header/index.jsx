                        ...
                        <div className='h-full'>
                            ...
                            >
                                <div className='container block z-40'>
                                    ...
                                    <button className='flex justify-center items-center px-8 py-3 h-full bg-red-600 rounded-full text-white font-bold gap-x-2'><PlayCircleOutlined /> WATCH TRAILER</button>
                                </div>
                            </div>
                        </div>
                    )
